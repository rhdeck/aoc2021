...
//   .map((char, index, arr) => ruleMap[char][arr[index + 1]])
//   .filter(Boolean);
// console.log(template);
// console.log(row2);
// const row3 = template
//   .map((char, index, arr) => ruleMap[char][row2[index]])
//   .filter(Boolean);
// console.log(row3);
// const row4 = row2.map((char, index, arr) => ruleMap[char][template[index + 1]]);
// console.log(row4);
// const getTemplateFrequency = (template: string[]) =>
//   template.reduce(
...
// const applyRules = (template: string[], rules: Record<string, string>) =>
//   template.flatMap((char, index, arr) =>
//     index && rules[arr[index - 1] + char]
//       ? [rules[arr[index - 1] + char], char]
//       : char
//   );

// const newTemplate = Array(10)
//   .fill(0)
//   .reduce((out, _) => applyRules(out, rules), template);

// const frequencies = getTemplateFrequencySorted(
//   getTemplateFrequency(newTemplate)
// );
// const top = frequencies[0];
// const bottom = frequencies[frequencies.length - 1];
// console.log("Part 1:", top[1] - bottom[1]);
// const newTemplate2 = Array(40)
//   .fill(0)
//   .reduce((out, _, index) => {
//     console.log("template length at start of round" + index, out.length);
//     console.time("Running round " + index);
//     const output = applyRules(out, rules);
//     console.timeEnd("Running round " + index);
//     return output;
//   }, template);

// const frequencies2 = getTemplateFrequencySorted(
//   getTemplateFrequency(newTemplate2)
// );
// const top2 = frequencies2[0];
// const bottom2 = frequencies2[frequencies2.length - 1];
// console.log("Part 2:", top2[1] - bottom2[1]);
